...
file_to_load = os.path.join("Election-Analysis-Module-3", "election_results.csv")
...
with open("election_analysis.txt", "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        cvotes_percentage = (cvotes / total_votes) * 100

         # 6d: Print the county results to the terminal.
        output = f"{county_name}: {cvotes_percentage:.1f}%, ({cvotes:,})\n"
        print(output)
        ...
        if (cvotes > largest_turnout_votes): 
            ...
            # largest_cvote_percentage = cvotes_percentage
    ...
    winning_county_summary = (
        f"------------------------------------------\n"
        f"Largest County Turnouts: {winning_candidate}\n"
        f"------------------------------------------\n"
    )
